...
class MessageSynchroniserNode:
	def __init__(self):
		self.synced_msgs = rospy.Publisher("/OS3/synchronised_problem", JointState, queue_size=5)

		arm_state_topic = "/openpose"
		franka_state_topic = "/franka_state_controller/franka_state"
		...
		ts = message_filters.ApproximateTimeSynchronizer([arm_state_sub, franka_state_sub], 10, 0.1, allow_headerless=True)
