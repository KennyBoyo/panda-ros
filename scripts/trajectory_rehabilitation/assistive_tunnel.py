...
class AssistiveTunnelController():
	def __init__(self, tunnelRadius: np.double, k_min, k_max):
		rospy.wait_for_service("training_trajectory")
		...
		self.stiffness_matrix_publisher = rospy.Publisher("/cartesian_impedance_equilibrium_controller/equilibrium_stiffness", StiffnessConfig)
